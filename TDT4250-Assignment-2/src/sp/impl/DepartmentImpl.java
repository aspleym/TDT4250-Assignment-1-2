 ...
 * </p>
 * <ul>
 *   <li>{@link sp.impl.DepartmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link sp.impl.DepartmentImpl#getProgrammes <em>Programmes</em>}</li>
 *   <li>{@link sp.impl.DepartmentImpl#getCourses <em>Courses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepartmentImpl extends MinimalEObjectImpl.Container implements Department {
	...
	public EList<Programme> getProgrammes() {
		if (programmes == null) {
			programmes = new EObjectContainmentEList<Programme>(Programme.class, this, SpPackage.DEPARTMENT__PROGRAMMES);
		}
		return programmes;
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentEList<Course>(Course.class, this, SpPackage.DEPARTMENT__COURSES);
		}
		return courses;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SpPackage.DEPARTMENT__COURSES:
